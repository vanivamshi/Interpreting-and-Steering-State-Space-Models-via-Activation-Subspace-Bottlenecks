...
class MambaAttentionNeurons:
    ...
    def visualize_neurons(self, mamba_neurons: dict, layer_idx: int = 0, save_path: Optional[str] = None):
        ...
        if 'neuron_activations' in neurons:
            ...
            axes[0, 0].set_xlabel('Neuron Index', fontsize=18, fontweight='bold')
            axes[0, 0].set_ylabel('Activation Value', fontsize=18, fontweight='bold')
        ...
        if 'neuron_importance' in neurons:
            ...
            axes[0, 1].set_xlabel('Neuron Index', fontsize=18, fontweight='bold')
            axes[0, 1].set_ylabel('Importance Score', fontsize=18, fontweight='bold')
        ...
        if 'attention_vectors' in neurons:
            ...
            axes[1, 0].set_xlabel('Sequence Position', fontsize=18, fontweight='bold')
            axes[1, 0].set_ylabel('Neuron Index', fontsize=18, fontweight='bold')
        ...
        if 'neuron_activations' in neurons:
            ...
            axes[1, 1].set_xlabel('Neuron Rank', fontsize=18, fontweight='bold')
            axes[1, 1].set_ylabel('Activation Value', fontsize=18, fontweight='bold')
