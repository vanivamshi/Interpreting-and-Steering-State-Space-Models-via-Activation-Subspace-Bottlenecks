...
class SSMComponentExtractor:
    ...
    def visualize_ssm_components(self, layer_idx: int, save_path: str = None):
        ...
        fig.suptitle(f'SSM Components - Layer {layer_idx}', fontsize=24)
        ...
        if components['A_matrix'] is not None:
            ...
            axes[0, 0].set_title('A Matrix (State Transition)', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('State Dimension', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('State Dimension', fontsize=27, fontweight='bold')
        ...
        if components['B_matrix'] is not None:
            ...
            axes[0, 1].set_title('B Matrix (Input Influence)', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Input Dimension', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('State Dimension', fontsize=27, fontweight='bold')
        ...
        if components['C_matrix'] is not None:
            ...
            axes[1, 0].set_title('C Matrix (Output Projection)', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('State Dimension', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Output Dimension', fontsize=27, fontweight='bold')
        ...
        if components['hidden_states'] is not None:
            ...
            axes[1, 1].set_title('Hidden State Evolution', fontsize=27, fontweight='bold')
            axes[1, 1].set_xlabel('Time Step', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Activation Value', fontsize=27, fontweight='bold')
            axes[1, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 1].legend(fontsize=24, prop={'weight': 'bold'})
