...
class RecursiveEmbeddingAttentionNeuronAnalyzer:
    ...
    def _plot_embedding_evolution(self, save_dir: str):
        ...
        fig.suptitle('Embedding Evolution Analysis Across Layers', fontsize=30, fontweight='bold')
        
        # Plot 1: Cosine Similarity
        if cosine_similarities:
            axes[0, 0].plot(range(len(cosine_similarities)), cosine_similarities, 'b-o', linewidth=2, markersize=6)
            axes[0, 0].set_title('Cosine Similarity Between Layers', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('Layer Transition', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('Cosine Similarity', fontsize=27, fontweight='bold')
        ...
        if l2_distances:
            ...
            axes[0, 1].set_title('L2 Distance Between Layers', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Layer Transition', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('L2 Distance', fontsize=27, fontweight='bold')
        ...
        if magnitude_changes:
            ...
            axes[1, 0].set_title('Embedding Magnitude Changes', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('Layer Transition', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Magnitude Change', fontsize=27, fontweight='bold')
        ...
        if cosine_similarities and l2_distances:
            ...
            axes[1, 1].set_title('Summary Statistics', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Average Value', fontsize=27, fontweight='bold')
    ...
    def _plot_chain_effects(self, save_dir: str):
        ...
        # Create comprehensive plot
        fig, axes = plt.subplots(2, 2, figsize=(15, 12))
        fig.suptitle('Embedding-Attention-Neuron Chain Effects', fontsize=30, fontweight='bold')
        ...
        if embedding_changes and attention_stabilities:
            ...
            axes[0, 0].set_title('Embedding Change vs Attention Stability', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('Embedding Change Magnitude', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('Attention Stability', fontsize=27, fontweight='bold')
            axes[0, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 0].grid(True, alpha=0.3)
        ...
        if correlation_ratios:
            ...
            axes[0, 1].set_title('Embedding-Attention Correlation Ratios', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Layer Transition', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('Correlation Ratio', fontsize=27, fontweight='bold')
            axes[0, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 1].grid(True, alpha=0.3)
        ...
        if attention_means and neuron_means:
            ...
            axes[1, 0].set_title('Attention Mean vs Neuron Mean', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('Attention Mean', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Neuron Mean', fontsize=27, fontweight='bold')
            axes[1, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 0].grid(True, alpha=0.3)
        ...
        if embedding_changes and attention_stabilities and correlation_ratios:
            ...
            axes[1, 1].set_title('Chain Effect Summary', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Value', fontsize=27, fontweight='bold')
            axes[1, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 1].tick_params(axis='x', rotation=45)
    ...
    def _plot_recursive_propagation(self, save_dir: str):
        ...
        # Create comprehensive plot
        fig, axes = plt.subplots(2, 2, figsize=(15, 12))
        fig.suptitle('Recursive Propagation Analysis', fontsize=30, fontweight='bold')
        ...
        if positions and trajectory_means:
            ...
            axes[0, 0].set_title('Embedding Trajectory Means by Position', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('Sequence Position', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('Trajectory Mean', fontsize=27, fontweight='bold')
            axes[0, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 0].grid(True, alpha=0.3)
        ...
        if positions and trajectory_stds:
            ...
            axes[0, 1].set_title('Trajectory Variability by Position', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Sequence Position', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('Trajectory Std', fontsize=27, fontweight='bold')
            axes[0, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 1].grid(True, alpha=0.3)
        ...
        if positions and stability_scores:
            ...
            axes[1, 0].set_title('Propagation Stability by Position', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('Sequence Position', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Stability Score', fontsize=27, fontweight='bold')
            axes[1, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 0].grid(True, alpha=0.3)
        ...
        if trajectory_means and trajectory_stds and stability_scores:
            ...
            axes[1, 1].set_title('Propagation Summary', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Value', fontsize=27, fontweight='bold')
            axes[1, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 1].tick_params(axis='x', rotation=45)
    ...
    def _plot_ssm_correlations(self, save_dir: str):
        ...
        # Create comprehensive plot
        fig, axes = plt.subplots(2, 2, figsize=(15, 12))
        fig.suptitle('SSM Correlation Analysis', fontsize=30, fontweight='bold')
        ...
        if spectral_radii and attention_stabilities:
            ...
            axes[0, 0].set_title('Spectral Radius vs Attention Stability', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('Spectral Radius', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('Attention Stability', fontsize=27, fontweight='bold')
            axes[0, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 0].grid(True, alpha=0.3)
        ...
        if layers and spectral_radii:
            ...
            axes[0, 1].set_title('Spectral Radius by Layer', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Layer Index', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('Spectral Radius', fontsize=27, fontweight='bold')
            axes[0, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 1].grid(True, alpha=0.3)
        ...
        if layers and attention_stabilities:
            ...
            axes[1, 0].set_title('Attention Stability by Layer', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('Layer Index', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Attention Stability', fontsize=27, fontweight='bold')
            axes[1, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 0].grid(True, alpha=0.3)
        ...
        if spectral_radii and attention_stabilities and correlations:
            ...
            bars = axes[1, 1].bar(metrics, values, color=['blue', 'green', 'orange', 'red'], alpha=0.7)
            axes[1, 1].set_title('SSM Correlation Summary', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Value', fontsize=27, fontweight='bold')
            axes[1, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 1].tick_params(axis='x', rotation=45)
    ...
    def _plot_memory_interaction(self, save_dir: str):
        ...
        # Create comprehensive plot
        fig, axes = plt.subplots(2, 2, figsize=(15, 12))
        fig.suptitle('Memory Interaction Analysis', fontsize=30, fontweight='bold')
        ...
        if delta_variations and attention_variations:
            ...
            axes[0, 0].set_title('Delta Variation vs Attention Variation', fontsize=27, fontweight='bold')
            axes[0, 0].set_xlabel('Delta Variation', fontsize=27, fontweight='bold')
            axes[0, 0].set_ylabel('Attention Variation', fontsize=27, fontweight='bold')
            axes[0, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 0].grid(True, alpha=0.3)
        ...
        if layers and variation_ratios:
            ...
            axes[0, 1].set_title('Memory-Attention Variation Ratios', fontsize=27, fontweight='bold')
            axes[0, 1].set_xlabel('Layer Index', fontsize=27, fontweight='bold')
            axes[0, 1].set_ylabel('Variation Ratio', fontsize=27, fontweight='bold')
            axes[0, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[0, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[0, 1].grid(True, alpha=0.3)
        ...
        if layers and delta_variations:
            ...
            axes[1, 0].set_title('Delta Variation by Layer', fontsize=27, fontweight='bold')
            axes[1, 0].set_xlabel('Layer Index', fontsize=27, fontweight='bold')
            axes[1, 0].set_ylabel('Delta Variation', fontsize=27, fontweight='bold')
            axes[1, 0].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 0].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 0].grid(True, alpha=0.3)
        ...
        if delta_variations and attention_variations and variation_ratios:
            ...
            bars = axes[1, 1].bar(metrics, values, color=['blue', 'green', 'orange', 'red'], alpha=0.7)
            axes[1, 1].set_title('Memory Interaction Summary', fontsize=27, fontweight='bold')
            axes[1, 1].set_ylabel('Value', fontsize=27, fontweight='bold')
            axes[1, 1].tick_params(axis='both', which='major', labelsize=24)
            axes[1, 1].tick_params(axis='both', which='minor', labelsize=21)
            axes[1, 1].tick_params(axis='x', rotation=45)
    ...
    def _plot_attention_propagation(self, save_dir: str):
        ...
        fig, axes = plt.subplots(2, 2, figsize=(15, 12))
        fig.suptitle('Attention Propagation Analysis', fontsize=20, fontweight='bold')
        ...
        if correlation_data:
            ...
            axes[0, 0].set_title('Attention Correlation Distribution', fontsize=18, fontweight='bold')
            axes[0, 0].set_xlabel('Correlation Coefficient', fontsize=18, fontweight='bold')
        ...
        if focus_shift_data:
            ...
            axes[0, 1].set_title('Attention Focus Shift Distribution', fontsize=18, fontweight='bold')
            axes[0, 1].set_xlabel('Focus Shift', fontsize=18, fontweight='bold')
