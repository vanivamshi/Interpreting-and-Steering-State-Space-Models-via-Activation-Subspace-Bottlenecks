...
def run_comprehensive_analysis():
    ...
    # Define layer indices for analysis - analyze all 24 layers
    num_layers = model.config.num_hidden_layers
    layer_indices = list(range(num_layers))  # Analyze all layers [0, 1, 2, ..., 23]
    print(f"🔍 Analyzing all {num_layers} layers: {layer_indices[:5]}...{layer_indices[-5:]}")
