...
def create_summary_plot(results: Dict, save_path: str = "analysis_summary.png"):
    ...
    fig.suptitle('Memory Recursion Analysis Summary', fontsize=20, fontweight='bold')
    ...
    if attention_results:
        ...
        if layer_means:
            ...
            axes[0, 0].set_title('Neuron Activations Across Layers', fontsize=18, fontweight='bold')
            axes[0, 0].set_xlabel('Layer Index', fontsize=18, fontweight='bold')
            axes[0, 0].set_ylabel('Mean Activation', fontsize=18, fontweight='bold')
    ...
    if memory_results:
        ...
        if layer_delta_magnitudes:
            ...
            axes[0, 1].set_title('Delta Magnitude Across Layers', fontsize=18, fontweight='bold')
            axes[0, 1].set_xlabel('Layer Index', fontsize=18, fontweight='bold')
            axes[0, 1].set_ylabel('Delta Magnitude', fontsize=18, fontweight='bold')
    ...
    if recursive_results:
        ...
        if layer_autocorrelations:
            ...
            axes[0, 2].set_title(f'Temporal Autocorrelation - Layer {first_layer}', fontsize=18, fontweight='bold')
            axes[0, 2].set_xlabel('Lag', fontsize=18, fontweight='bold')
            axes[0, 2].set_ylabel('Autocorrelation', fontsize=18, fontweight='bold')
    ...
    if ssm_results:
        ...
        if layer_spectral_radius:
            ...
            axes[1, 0].set_title('Spectral Radius Across Layers', fontsize=18, fontweight='bold')
            axes[1, 0].set_xlabel('Layer Index', fontsize=18, fontweight='bold')
            axes[1, 0].set_ylabel('Spectral Radius', fontsize=18, fontweight='bold')
    ...
    if cross_layer_results:
        ...
        if correlations:
            ...
            axes[1, 1].set_title('Cross-Layer Correlations', fontsize=18, fontweight='bold')
            axes[1, 1].set_xlabel('Layer Pairs', fontsize=18, fontweight='bold')
            axes[1, 1].set_ylabel('Mean Correlation', fontsize=18, fontweight='bold')
    ...
    if attention_results:
        ...
        if method_comparison:
            ...
            axes[1, 2].set_title('Neuron Activation by Method', fontsize=18, fontweight='bold')
            axes[1, 2].set_xlabel('Method', fontsize=18, fontweight='bold')
            axes[1, 2].set_ylabel('Mean Activation', fontsize=18, fontweight='bold')
