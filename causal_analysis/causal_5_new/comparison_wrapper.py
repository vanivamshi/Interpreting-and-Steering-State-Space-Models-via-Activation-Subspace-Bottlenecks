...
def run_quick_comparison(texts: List[str]):
    ...
    fig.suptitle('Quick Mamba vs Transformer Comparison', fontsize=22, fontweight='bold')
    ...
    ax.set_ylabel('Mean Activation Variance', fontsize=18)
    ax.set_title('Layer-wise Activation Variance', fontsize=18, fontweight='bold')
    ...
    ax.set_title('Layer-wise Sparsity', fontsize=18, fontweight='bold')
    ax.tick_params(labelsize=16)
    ax.legend(fontsize=16)
    ax.grid(True, alpha=0.3)
    ...
    ax.set_xlabel('Causal Impact Score', fontsize=18)
    ax.set_ylabel('Density', fontsize=18)
    ax.set_title('Causal Impact Distribution', fontsize=18, fontweight='bold')
    ax.tick_params(labelsize=16)
    ax.legend(fontsize=16)
    ax.grid(True, alpha=0.3)
    ...
    ax.set_title('Model Comparison Summary', fontsize=18, fontweight='bold')
