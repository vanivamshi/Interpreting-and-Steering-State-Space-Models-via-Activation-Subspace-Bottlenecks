...
def plot_neuron_activation_distribution(model, tokenizer, texts, layer_idx=0, save_dir="plots", test_threshold=1e-1):
    ...
    plt.title(f'Distribution of Max Activations (Layer {layer_idx})', fontsize=22, fontweight='bold')
    plt.yscale('log')
    ...
    plt.xlabel('Activation Frequency', fontsize=20, fontweight='bold')
    plt.ylabel('Number of Neurons', fontsize=20, fontweight='bold')
    plt.title(f'Distribution of Activation Frequencies (Layer {layer_idx})', fontsize=22, fontweight='bold')
    plt.yscale('log')
    plt.legend(fontsize=16, prop={'weight': 'bold'})
    plt.tick_params(axis='both', which='major', labelsize=18)
    plt.tick_params(axis='both', which='minor', labelsize=16)
    ...
    plt.xlabel('Maximum Activation Value', fontsize=20, fontweight='bold')
    plt.ylabel('Activation Frequency', fontsize=20, fontweight='bold')
    plt.title(f'Max Activation vs Frequency (Layer {layer_idx})', fontsize=22, fontweight='bold')
    plt.xscale('log')
    plt.yscale('log')
    ...
    plt.xlabel('Maximum Activation Value', fontsize=20, fontweight='bold')
    plt.ylabel('Cumulative Fraction of Neurons', fontsize=20, fontweight='bold')
    plt.title(f'Cumulative Distribution of Max Activations (Layer {layer_idx})', fontsize=22, fontweight='bold')
    plt.xscale('log')
