...
def plot_neuron_activation_distribution(model, tokenizer, texts, layer_idx=0, save_dir="plots", test_threshold=1e-1):
    ...
    plt.title(f'Distribution of Max Activations (Layer {layer_idx})', fontsize=20, fontweight='bold')
    ...
    plt.xlabel('Activation Frequency', fontsize=18)
    plt.ylabel('Number of Neurons', fontsize=18)
    plt.title(f'Distribution of Activation Frequencies (Layer {layer_idx})', fontsize=20, fontweight='bold')
    plt.tick_params(labelsize=16)
    plt.yscale('log')
    plt.legend()
    ...
    plt.xlabel('Maximum Activation Value', fontsize=18)
    plt.ylabel('Activation Frequency', fontsize=18)
    plt.title(f'Max Activation vs Frequency (Layer {layer_idx})', fontsize=20, fontweight='bold')
    plt.tick_params(labelsize=16)
    plt.xscale('log')
    plt.yscale('log')
    ...
    plt.xlabel('Maximum Activation Value', fontsize=18)
    plt.ylabel('Cumulative Fraction of Neurons', fontsize=18)
    plt.title(f'Cumulative Distribution of Max Activations (Layer {layer_idx})', fontsize=20, fontweight='bold')
    plt.tick_params(labelsize=16)
    plt.xscale('log')
